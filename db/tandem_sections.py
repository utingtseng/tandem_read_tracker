...
cur.execute("CREATE TABLE tandem_sections(id, book_id, start, end, description, read)")
cur.executemany("INSERT INTO tandem_sections (id, book_id, start, end, description) values (?, ?, ?, ?, ?)", params)
con.commit()
